...
public class ShippingAdapter extends RecyclerView.Adapter<ShippingAdapter.ViewHolder> {
    ...
    private OnItemClickListener3 mItemClickListener;

    public void setOnItemClickListener(OnItemClickListener3 mItemClickListener) {
        this.mItemClickListener = mItemClickListener;
    }


    public ShippingAdapter(Context context, List<Transaction_hdr> transaction_hdrList) {
    ...
    @Override
    public ShippingAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final ShippingAdapter.ViewHolder holder, final int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
           ...
           // btnGo = (Button) itemView.findViewById(R.id.btn_Go);
